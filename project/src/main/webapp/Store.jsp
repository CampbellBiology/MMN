...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="style_ImagePopUp.css">
...
<body>
	...
	String keep_btn_path = "UI/keep_btn.png";
	String keep_btn_sel_path = "UI/keep_btn_sel.png";
	%>
            ...
            <div id="store">
                <div id="store_photo"> 가게 이미지 및 음식 사진
                    ...
                    <div id="small_photo" class="photo"><button id="show">팝업열기</button></div>
                </div>
                <div id="store_info">
                    <div id="store_name"><%=sd.storeName%></div>
                    <div id="store_keep"><img id="keepImg" src="<%=keep_btn_path%>" width=100px
							onclick="keepClick()" onmouseover="onHover()"
							onmouseout="offHover()"></div>
		...
		+ "<br> 브레이크 타임 : " + (sd.breakStart == null ? "정보 없음" : sd.breakStart + " - " + sd.breakEnd)%><br></div>
                </div>


                <div id="store_static">
                    <div id="favorite" class="store_static">뭐뭇나 회원이 가장 많이 먹은 음식은?
                    <%="<br>"%>
						<%
		...
		%>
                ...
                <div id="third_row">
                    ...
                    <div id="forth_row">
                        ...
                        <div id="add_tag">
                            <div id="create_tag1" class="create_tag"><input type="text" placeholder="ex.#비오는날"></div>
                            <div id="create_tag2" class="create_tag"><button type="button">추가아이콘</button></div>
                    ...
                    <div id="fifth_row">
                        <div><input type="text" placeholder="리뷰를 작성해주세요. 최대 4000자"></div>
                    </div>
            ...
            <div id="show_review">
                ...
                <div id="review_detail">
                    ...
                    <div id="forth_line">
                        <div id="riview_contents">리뷰 내용이 될 부분<br>뫄뫄뫄뫄 </div>
                    </div>

                    <div id="fifth_line">
                        <div id="show_images"> 이미지 넣는 부분<br>
                ...
                <div class="background">
                    <div class="window">
                        ...
                        <div class="popup">
                            ...
                            <!-- 슬라이드 CSS 라이브러리 -->
                            <div id="mainImage">
                                <img src="storeImg/1.jpg" id="main_image" width="400px">
                            </div>
                            <!-- 우측 리뷰 영역 -->
                            <div id="pop_riview">
                                <div id="user_profile"><img src="UI/keep_btn_hover.png"></div>
                            ...
                            <section class="center slider">
                                <div>
                                    <img src="storeImg/1.jpg">
                                </div>
                                <div>
                                    <img src="storeImg/2.jpg">
                                </div>
                                <div>
                                    <img src="storeImg/3.jpg">
                                </div>
                                <div>
                                    <img src="storeImg/4.jpg">
                                </div>
                                <div>
                                    <img src="storeImg/5.jpg">
                                </div>
                                <div>
                                    <img src="storeImg/6.jpg">
                                </div>
                                <div>
                                    <img src="storeImg/7.jpg">
                                </div>
                                <div>
                                    <img src="storeImg/8.jpg">
                                </div>
                                <div>
                                    <img src="storeImg/9.jpg">
                                </div>
